...
param_file_name = os.path.join(__location__, 'trained_weigths/best_param_100.pkl')
dct_file_name = 'best_weights_100/dct_best.pkl'
svm_file_name = 'best_weights_100/svm_best.pkl'
rft_file_name = 'best_weights_100/rft_best.pkl'
knn_file_name = 'best_weights_100/knn_best.pkl'
...
#>>>>>>>>>>>>>>>>>>>>> PLOT START  #<<<<<<<<<<<<<<<<<<<<
    ...
    ax.set_xlabel('Tree_max_depths')
    ax.set_ylabel('n_feats')
    ax.set_zlabel('Test Accuracy')
    img = ax.scatter(acc_plot_x,acc_plot_y,acc_plot_c)
    ...
    ax2.set_xlabel('Tree_max_depths')
    ax2.set_ylabel('n_feats')
    ax2.set_zlabel('Train Accuracy')
    img2 = ax2.scatter(acc_plot_x, acc_plot_y, acc_plot_train_c)
